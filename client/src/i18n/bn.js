...
export default {
  ...
  'player.videoSpeed': 'ভিডিওর গতি',
  'player.videoSpeedNormal': 'স্বাভাবিক গতি',
  'player.videoSpeedValue': '{rate} গুণ গতি',
  ...
  'timeline.filterLabel': 'বর্ণনা খুঁজুন',
  'timeline.filterPlaceholder': 'একটি শব্দ, বা 4:20 এর মতো সময়',
  'timeline.filterCount': '{count}টি বর্ণনা মিলেছে।',
  'timeline.filterNone': 'কোনো বর্ণনার সঙ্গে {query} মেলেনি।',
  'timeline.exportGroup': 'এই বর্ণনাগুলি ডাউনলোড করুন',
  'timeline.exportText': 'টেক্সট হিসেবে ডাউনলোড করুন',
  'timeline.exportVtt': 'সাবটাইটেল হিসেবে ডাউনলোড করুন',
  ...
  'shortcuts.videoSlower': 'ভিডিও ধীরে চালান',
  'shortcuts.videoFaster': 'ভিডিও দ্রুত চালান',
  ...
  'announce.videoRate': 'ভিডিওর গতি {rate} গুণ।',
  'announce.resumed':
    'গতবার যেখানে থেমেছিলেন, {position} থেকে চলছে। শুরু থেকে দেখতে Home চাপুন।',
  'announce.exported': 'বর্ণনাগুলি ডাউনলোড হয়েছে।',
